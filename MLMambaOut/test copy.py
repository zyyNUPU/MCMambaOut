...
def visualize_grid(model, dataloader, attributes, device, csv_location=None, checkpoint=None):
    ...
    with torch.no_grad():
        ...
        # 保存到新 CSV 文件
        result_df.to_csv(os.path.join(csv_location, "LISA_LF_QC_predictions.csv"), index=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default="/home/zyy/Modules/Classification/PyTorch-Multi-Label-Image-Classification/parameter/MambaOut_muti_pre13.pth", help="Path to the checkpoint")
    ...
    test_file_name = "test_sort_patch"
